exports('vorp_inventoryApi',function()
    ...
    self.addItem = function(source,itemName,cuantity)
        ...
        TriggerEvent("vorpinventory:getLabelFromId", itemName, function(name)
            TriggerClientEvent("vorp:TipRight", source, "Ricevuto " .. tostring(cuantity) .. " di " .. name, 4000)
        end)
    end
    ...
    self.subItem = function(source,itemName,cuantity)
        ...
        TriggerEvent("vorpinventory:getLabelFromId", itemName, function(name)
            TriggerClientEvent("vorp:TipRight", source, "Rimosso " .. tostring(cuantity) .. " di " .. name, 4000)
        end)
