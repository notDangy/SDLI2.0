...
local function drawTitle()
	if menus[currentMenu] then
		...
		DrawSprite("menu_textures", "translate_bg_1a", x, y, menus[currentMenu].width, titleHeight, 0.8, 161, 3, 0, 255)   -- 0.8
		DrawSprite("generic_textures", "menu_header_1a", x, y, menus[currentMenu].width - 0.45, titleHeight, 0.0, 255, 255, 255, 255, 0) -- -0.45
