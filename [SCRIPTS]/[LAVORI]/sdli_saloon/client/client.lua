...
RegisterNetEvent('saloon:checkgroupcl')
AddEventHandler('saloon:checkgroupcl', function() 
    TriggerEvent("saloon:open")
end)
...
Citizen.CreateThread(function()
    ...
    while true do
        ...
        elseif WarMenu.IsMenuOpened('hgmake') then
            ...
            if WarMenu.Button('Vodka') then
		
		        TriggerServerEvent("wc_vodka")
            

		    elseif WarMenu.Button('Whiskey') then
            ...
            elseif WarMenu.Button('Rum') then
...
AddEventHandler('saloon:open', function()
