...
Citizen.CreateThread(function()
    ...
    WarMenu.CreateSubMenu('men5', 'menu', 'Soldi')
    ...
    while true do
        ...
        if WarMenu.MenuButton('Soldi', 'men5') then
            end	
        ...
        if WarMenu.Button('3$ - Coltello Mandibola (Jawbone)') then
		
        TriggerServerEvent("mn_jawbone")
        
        elseif WarMenu.Button('20$ - Arco Migliorato (Improved)') then
		
        TriggerServerEvent("mn_improved")
			
		elseif WarMenu.Button('26$ - Revolver Cattleman di Flaco (Mexican)') then
		
        TriggerServerEvent("mn_revmex")
            
        elseif WarMenu.Button('10$ - Revolver a doppia azione Azzardo (Gambler)') then
            
        TriggerServerEvent("mn_revgamb")

        elseif WarMenu.Button('55$ - Revolver Navy') then
            
        TriggerServerEvent("mn_revnavy")

        elseif WarMenu.Button('58$ - Doppietta esotica') then
        ...
        if WarMenu.Button('Compra Grimaldello') then
